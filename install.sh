...
# @File          : powershell
# @Description   : Installer script for powershell
# @TODO          :
# @Other         :
# @Resource      :
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Custom functions
powershell() { { [ -n "$(type -p pwsh 2>/dev/null)" ] || [ -n "$(type -p pwsh-preview 2>/dev/null)" ]; } && return 0 || return 1; }
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
